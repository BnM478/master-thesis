...
AFRAME.registerComponent('hold-drag', {
  ...
  fingerDown: function (event) {
    ...
    this.changableUI.setAttribute('visible', 'false')
  ...
  fingerUp: function (event) {
    ...
    if (this.internalState.dragging) {
      ...
      this.changableUI.setAttribute('position', `${endPosition.x} 0 ${endPosition.z}`)
    ...
    this.changableUI.setAttribute('visible', 'true')
